    ...
    <div className="relative overflow-hidden rounded-xl border border-cave-border bg-card">
      ...
      <div className="absolute inset-y-0 right-0 flex items-stretch" style={{ width: SWIPE_REVEAL }}>
        <button
          ...
          className="flex flex-1 flex-col items-center justify-center gap-1 bg-amber-500/90 text-white text-xs font-medium"
        >
        ...
        <button
          ...
          className="flex flex-1 flex-col items-center justify-center gap-1 bg-muted text-muted-foreground text-xs font-medium"
        >
          <span className="text-lg">📦</span>
          Archiver
        </button>
      ...
      <div
        ...
        style={{
          ...
          transition: Math.abs(touchX) > 0 && isHorizontalRef.current ? 'none' : 'transform 0.2s ease',
